    ...
    <header className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 
      ...
      <div className="max-w-7xl mx-auto px-0 sm:px-1 lg:px-2 relative">
        <div className="flex justify-between items-center">
          ...
          <a href="tel:5088164697" className="hidden md:flex items-center gap-2 text-black font-medium rounded-full px-6 py-2.5 transition-all border border-black/10 shadow-sm hover:shadow-md hover:bg-black hover:text-white hover:border-transparent hover:translate-y-[-2px] active:translate-y-[1px]">
      ...
      {/* Mobile Menu */}
      <div className={`md:hidden fixed inset-0 bg-black/5 backdrop-blur-sm z-50 transform transition-all duration-300 ease-in-out ${mobileMenuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
